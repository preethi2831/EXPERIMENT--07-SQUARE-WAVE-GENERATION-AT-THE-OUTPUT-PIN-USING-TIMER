...
## Output screen shots of proteus  :
 ...
 ![image](https://github.com/user-attachments/assets/6f02a7ce-62f0-4c2e-afeb-01570e1ccf7d)

 ![image](https://github.com/user-attachments/assets/315a5696-f881-44ab-88c1-3b5191131505)

 ![image](https://github.com/user-attachments/assets/161ea6e5-1c45-4ea9-958d-88a9d909a6e8)

![image](https://github.com/user-attachments/assets/c25a03ec-10d8-4476-a600-1cd6fd876982)
...
TON = 2.5ms TOFF=2.5ms TOTAL TIME = 5ms FREQUENCY = 1/(5*10^-3)= 200Hz

FOR PULSE AT 600

TON = 3ms TOFF= 2ms TOTAL TIME = 5ms FREQUENCY = 1/(TOTAL TIME)=200Hz

FOR PULSE AT 700

TON = 3.5ms TOFF=1.5ms TOTAL TIME = 5ms FREQUENCY = 1/(TOTAL TIME)=200Hz
